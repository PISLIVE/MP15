...
export function Login() {
  ...
  return (
    ...
    <div className="min-h-screen grid grid-cols-1 lg:grid-cols-2">
      ...
      {/* LEFT HERO SECTION */}
      <div className="hidden lg:flex flex-col justify-between p-12 bg-gradient-to-br from-gray-900 via-blue-900 to-indigo-900 text-white relative overflow-hidden">
